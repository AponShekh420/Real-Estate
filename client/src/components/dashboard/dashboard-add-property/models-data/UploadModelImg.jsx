      ...
      <div className="profile-box position-relative d-md-flex align-items-end mb50">
        <div className="profile-img new position-relative overflow-hidden bdrs12 mb20-sm">
          <Image
            ...
            src={(!uploadedImageChanged && oldImgUrl ) ? `${process.env.NEXT_PUBLIC_SERVER_IMG_PATH}/assets/communityModels/${oldImgUrl}` : uploadedImage || "/images/listings/profile-1.jpg"}
            alt="profile avatar"
          />
