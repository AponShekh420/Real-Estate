...
const CommunityPublish = ({submitBtn}) => {
  ...
  return (
    <div className="dashboard_title_area">
      <button onClick={communityhandler} className={`bdr1 bg-black text-white rounded-3 shadow mb-5 py-2 px-3 d-flex gap-2 justify-content-center align-items-center fs-6 ${loading? "opacity-50" : "opacity-100"}`} disabled={loading}>
