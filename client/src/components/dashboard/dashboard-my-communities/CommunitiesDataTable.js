              ...
              <div className="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                <div className="list-thumb">
                  <Image
                    ...
                    height={94}
                    className="w-100"
                    src={community?.thumbnail ? `${process.env.SERVER_IMG_PATH}/assets/communityImgs/${community?.thumbnail}` : `${process.env.SERVER_IMG_PATH}/assets/communityImgs/${community?.imgs[community?.imgs?.length -1]}`}
                    alt="community"
                  />
                </div>
