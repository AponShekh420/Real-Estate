                      ...
                      <div className="dropdown">
                        <a className="btn" href="#" data-bs-toggle="dropdown">
                         <Image
                            ...
                            src={userInfo?.avatar?.split("/")[2] !== "lh3.googleusercontent.com" ? userInfo?.avatar ? `${process.env.SERVER_IMG_PATH}/assets/users/${userInfo?.avatar}` : "/images/user_avatar.png" : userInfo?.avatar}
