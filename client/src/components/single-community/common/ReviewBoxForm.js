  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_API}/api/review/add`,
        {
          method: "POST",
          credentials: "include",
          headers: {
      ...
      >
        <div className="row">
            ...
            <div className="widget-wrapper sideborder-dropdown mb-4">
              ...
              <div className="form-style2 input-group">
                <Select
                  ...
                  value={{
                    value: rating,
                    label: inqueryType[rating - 1].label,
                  }}
                />
                <p
          ...
          <div className="col-md-12">
            ...
            <button
              type={userInfo ? "submit" : "button"}
              className={`ud-btn btn-white2 d-flex align-items-center justify-content-center ${
                loading || !userInfo ? "opacity-50" : "opacity-100"
              }`}
