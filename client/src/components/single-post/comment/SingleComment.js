        ...
        <div className="col-md-12" key={index}>
          <div className="mbp_first position-relative d-flex align-items-center justify-content-start mt30 mb30-sm">
            <Image
              ...
              src={comment?.user?.avatar?.split("/")[2] !== "lh3.googleusercontent.com" ? `${process.env.SERVER_IMG_PATH}/assets/users/${comment?.user?.avatar}` : comment?.user?.avatar || "/images/user_avatar.png"}
