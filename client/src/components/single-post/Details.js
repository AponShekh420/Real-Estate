              ...
              <div className="blog-single-meta">
                <div className="post-author d-sm-flex align-items-center">
                  <Image
                    ...
                    src={data?.auther?.avatar?.split("/")[2] !== "lh3.googleusercontent.com" ? data?.auther?.avatar ? `${process.env.NEXT_PUBLIC_SERVER_IMG_PATH}/assets/users/${data?.auther?.avatar}` : "/images/user_avatar.png" : data?.auther?.avatar}
            ...
            <div className="col-lg-12">
              <div className="large-thumb h580">
                <Image
                  ...
                  src={`${process.env.NEXT_PUBLIC_SERVER_IMG_PATH}/assets/blogs/${data.img}`}
                  alt={data?.title}
                />
              </div>
            </div>
