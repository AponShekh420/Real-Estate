    ...
    <>
      ...
      <section className="pt-0 pb60">
        <div className="container" data-aos="fade-up" data-aos-delay="300">
          ...
          <RecentBlogs blogsCatagory={null} total={6} dateStatus={true} notCatagory={process.env.NEXT_PUBLIC_SPECIFIC_CETEGORY_HOME}/>
          <RecentBlogs blogsCatagory={process.env.NEXT_PUBLIC_SPECIFIC_CETEGORY_HOME} total={3} dateStatus={false} notCatagory={""}/>
        </div>
      </section>
